...
| [Deploy Standalone Nemotron 3.5 Lightning on NVCF](how-to/deploy-nvcf-lightning-function.md) | Deploy the Lightning NIM as an isolated OpenAI-compatible NVCF endpoint |
